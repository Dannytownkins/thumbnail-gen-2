...
const capturePillars = [
  {
    ...
    icon: Camera,
    color: 'from-brand-teal/40 via-brand-teal/5 to-transparent',
  ...
  },
  {
    ...
    icon: Zap,
    color: 'from-brand-red/40 via-brand-red/5 to-transparent',
  ...
  },
  {
    ...
    icon: ImageIcon,
    color: 'from-brand-teal/20 via-brand-red/5 to-transparent',
